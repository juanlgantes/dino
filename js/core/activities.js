...
export const ACTIVITIES_DATA = {
  ...
  armonia: {
    ...
    games: [
      {
        question: "¿Qué hace Dino antes de comer?",
        options: ["🧼 Lavarse las manos", "📺 Ver TV", "🏃 Correr", "😴 Dormir"],
        correct: 0,
      },
      {
        question: "¿Qué parte del cuerpo usa Dino para caminar?",
        options: ["👂 Orejas", "👃 Nariz", "🦵 Piernas", "👀 Ojos"],
        correct: 2,
      },
      {
        question: "¿Cuándo nos cepillamos los dientes?",
        options: [
          "🥐 Mientras comemos",
          "🦷 Después de comer",
          "🚫 Nunca",
      ...
      {
        question: "¿Qué decimos al pedir algo?",
        options: ["😡 ¡Dámelo!", "🙏 Por favor", "😤 No quiero", "👋 Adiós"],
        correct: 1,
      },
      {
        question: "¿Dónde guardamos los juguetes?",
        options: [
          "🗑️ En la basura",
          "🏠 En el techo",
          "📦 En la caja",
      ...
      {
        question: "¿Qué hacemos si un amigo está triste?",
        options: ["😂 Reírnos", "😠 Empujarle", "🤗 Darle un abrazo", "🏃 Irnos"],
        correct: 2,
      },
      {
        question: "¿Qué hacemos por la noche?",
        options: [
          "🏫 Ir al colegio",
          "⚽ Jugar al fútbol",
          "😴 Dormir y descansar",
  ...
  exploracion: {
    ...
    games: [
      {
        question: "¿Qué es más GRANDE?",
        options: ["🐘 Elefante", "🐜 Hormiga", "🐱 Gato", "🐭 Ratón"],
        correct: 0,
      },
      {
  ...
  comunicacion: {
    ...
    games: [
      {
        question: "¿Qué número es este? 1️⃣",
        options: ["Cero", "Uno", "Dos", "Tres"],
        correct: 1,
      },
      {
        question: 'En inglés, ¿cómo se dice "Rojo"?',
  ...
  religion: {
    ...
    games: [
      {
        question: "¿Quién nació en Navidad?",
        options: ["🎅 Santa Claus", "👼 Jesús", "⛄ Muñeco de nieve", "🦌 Rodolfo"],
        correct: 1,
      },
      {
        question: "¿Dónde nació Jesús?",
        options: ["🏰 Castillo", "🏠 Casa", "⭐ Belén", "🏫 Escuela"],
        correct: 2,
      },
    ],
  },
  emociones: {
    ...
    games: [
      {
        question: "¿Quién está FELIZ? 😄",
        options: ["😠", "😢", "😄", "😴"],
        correct: 2,
      },
      {
        question: "¿Quién está TRISTE? 😢",
        options: ["😄", "😢", "😲", "😡"],
        correct: 1,
      },
      {
        question: "¿Quién tiene MIEDO? 😨",
        options: ["😨", "😎", "😆", "😐"],
        correct: 0,
      },
      {
        question: "¿Quién está ENFADADO? 😠",
        options: ["😴", "😠", "😄", "😢"],
        correct: 1,
      },
      {
        question: "¿Quién está SORPRENDIDO? 😲",
        options: ["😐", "😲", "😴", "😆"],
        correct: 1,
      },
      {
        question: "¿Quién tiene SUEÑO? 😴",
        options: ["😄", "😴", "😠", "😨"],
        correct: 1,
      },
      {
        question: "¿Quién siente AMOR? 😍",
        options: ["😍", "😢", "😠", "😐"],
        correct: 0,
      },
    ],
  ...
  cuerpo: {
    ...
    games: [
      {
        question: "¿Dónde está la NARIZ? (Nose)",
        options: ["👁️ Ojo", "👃 Nariz", "👂 Oreja", "👄 Boca"],
        correct: 1,
      },
      {
        question: "Where are the EYES? (Ojos)",
        options: ["👃 Nose", "🦵 Leg", "👁️ Eyes", "✋ Hand"],
        correct: 2,
      },
      {
        question: "¿Cuál es la BOCA? (Mouth)",
        options: ["👄 Boca", "👁️ Ojo", "👂 Oreja", "🦶 Pie"],
        correct: 0,
      },
      {
        question: "Where is the HAND? (Mano)",
        options: ["🦶 Foot", "✋ Hand", "👃 Nose", "🦵 Leg"],
        correct: 1,
      },
      {
        question: "¿Dónde está la OREJA? (Ear)",
        options: ["👂 Oreja", "👄 Boca", "👁️ Ojo", "✋ Mano"],
        correct: 0,
      },
      {
        question: "Where is the FOOT? (Pie)",
        options: ["✋ Hand", "👃 Nose", "🦶 Foot", "👁️ Eye"],
        correct: 2,
      },
      {
        question: "¿Dónde está la PIERNA? (Leg)",
        options: ["💪 Brazo", "🦵 Pierna", "🦶 Pie", "👃 Nariz"],
        correct: 1,
      },
    ],
  },
  colores: {
    ...
    games: [
      {
        question: "Which one is RED? 🔴 (Rojo)",
        options: ["🟦", "🟥", "🟩", "🟨"],
        correct: 1,
      },
      {
        question: "Which one is BLUE? 🔵 (Azul)",
        options: ["🟥", "🟨", "🟦", "🟧"],
        correct: 2,
      },
      {
        question: "Which one is GREEN? 🟢 (Verde)",
        options: ["🟩", "🟪", "🟦", "🟫"],
        correct: 0,
      },
      {
        question: "Which one is YELLOW? 🟡 (Amarillo)",
        options: ["🟧", "🟨", "⬛", "🟥"],
        correct: 1,
      },
      {
        question: "Which one is ORANGE? 🟠 (Naranja)",
        options: ["🟧", "🟥", "🟪", "🟦"],
        correct: 0,
      },
      {
        question: "Which one is PURPLE? 🟣 (Morado)",
        options: ["🟦", "🟩", "🟪", "⬛"],
        correct: 2,
      },
      {
        question: "Which one is BLACK? ⚫ (Negro)",
        options: ["⬜", "⬛", "🟫", "🟥"],
        correct: 1,
      },
      {
        question: "Which one is WHITE? ⚪ (Blanco)",
        options: ["⬛", "⬜", "🟨", "🟦"],
        correct: 1,
      },
    ],
  ...
  room: {
    title: "🛏️ Ordena tu Habitación",
    description: "Juego de Atención y Orden",
    type: "room",
    class: RoomGame,
    icon: "🛏️",
    theme: "linear-gradient(135deg, #2ecc71 0%, #27ae60 100%)",
  },
  breathe: {
    title: "🧘 Respiración",
    description: "Relájate con Dino",
    type: "breathe",
    class: BreatheGame,
    icon: "🧘",
    theme: "linear-gradient(135deg, #3498db 0%, #2980b9 100%)",
  },
};
