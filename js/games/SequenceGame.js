...
export class SequenceGame {
  constructor(data, container) {
    ...
    this.DATA = {
      ...
      shapes: [
        {
          seq: ["shape_triangle", "shape_square", "shape_triangle", "?"],
          ans: "shape_square",
          opts: ["shape_triangle", "shape_square", "shape_star"],
        },
        {
          seq: ["shape_star", "shape_moon", "shape_star", "shape_moon", "?"],
          ans: "shape_star",
          opts: ["shape_moon", "shape_star", "shape_sun"],
        },
        {
          seq: [
            "shape_square",
          ...
          ans: "shape_square",
          opts: ["shape_square", "shape_circle", "shape_triangle"],
        },
      ],
      colors: [
        { seq: ["🔴", "🔵", "🔴", "?"], ans: "🔵", opts: ["🔴", "🔵", "🟢"] },
