export class ConnectDotsGame {
            constructor(data, container) {
                ...
                this.levels = [
                    ...
                    },
                    {
                        name: "ESTRELLA ⭐",
                        points: [
                            { x: 0.5, y: 0.1 }, { x: 0.6, y: 0.4 }, { x: 0.9, y: 0.4 }, { x: 0.65, y: 0.6 },
                            { x: 0.75, y: 0.9 }, { x: 0.5, y: 0.7 }, { x: 0.25, y: 0.9 }, { x: 0.35, y: 0.6 },
                    ...
                    },
                    {
                        name: "CORAZÓN ❤️",
                        points: [
                            { x: 0.5, y: 0.3 }, { x: 0.7, y: 0.1 }, { x: 0.9, y: 0.3 }, { x: 0.9, y: 0.5 },
                            { x: 0.5, y: 0.9 }, { x: 0.1, y: 0.5 }, { x: 0.1, y: 0.3 }, { x: 0.3, y: 0.1 },
                            { x: 0.5, y: 0.3 }
                        ]
                    },
                    {
                        name: "CASA 🏠",
                        points: [
                            { x: 0.2, y: 0.4 }, { x: 0.5, y: 0.1 }, { x: 0.8, y: 0.4 }, { x: 0.8, y: 0.9 },
                            { x: 0.2, y: 0.9 }, { x: 0.2, y: 0.4 }
                        ]
                    },
                    {
                        name: "BARCO ⛵",
                        points: [
                            { x: 0.2, y: 0.7 }, { x: 0.8, y: 0.7 }, { x: 0.7, y: 0.9 }, { x: 0.3, y: 0.9 },
                            { x: 0.2, y: 0.7 }, { x: 0.5, y: 0.6 }, { x: 0.5, y: 0.1 }, { x: 0.2, y: 0.6 },
                            { x: 0.8, y: 0.6 }, { x: 0.5, y: 0.1 }
                        ]
                    },
                    {
                        name: "LUNA 🌙",
                        points: [
                            { x: 0.5, y: 0.1 }, { x: 0.7, y: 0.2 }, { x: 0.8, y: 0.5 }, { x: 0.7, y: 0.8 },
                            { x: 0.5, y: 0.9 }, { x: 0.6, y: 0.7 }, { x: 0.65, y: 0.5 }, { x: 0.6, y: 0.3 },
                            { x: 0.5, y: 0.1 }
                        ]
                    },
                    {
                        name: "SOL ☀️",
                        points: [
                            { x: 0.5, y: 0.2 }, { x: 0.65, y: 0.25 }, { x: 0.8, y: 0.5 }, { x: 0.65, y: 0.75 },
                            { x: 0.5, y: 0.8 }, { x: 0.35, y: 0.75 }, { x: 0.2, y: 0.5 }, { x: 0.35, y: 0.25 },
                            { x: 0.5, y: 0.2 }
                        ]
                    },
                    {
                        name: "ÁRBOL 🌲",
                        points: [
                            { x: 0.5, y: 0.1 }, { x: 0.7, y: 0.4 }, { x: 0.6, y: 0.4 }, { x: 0.8, y: 0.7 },
                            { x: 0.6, y: 0.7 }, { x: 0.6, y: 0.9 }, { x: 0.4, y: 0.9 }, { x: 0.4, y: 0.7 },
                            { x: 0.2, y: 0.7 }, { x: 0.4, y: 0.4 }, { x: 0.3, y: 0.4 }, { x: 0.5, y: 0.1 }
                        ]
                    },
                    {
                        name: "COCHE 🚗",
                        points: [
                            { x: 0.2, y: 0.7 }, { x: 0.1, y: 0.5 }, { x: 0.2, y: 0.5 }, { x: 0.3, y: 0.3 },
                            { x: 0.6, y: 0.3 }, { x: 0.7, y: 0.5 }, { x: 0.9, y: 0.5 }, { x: 0.9, y: 0.7 },
                            { x: 0.2, y: 0.7 }, { x: 0.3, y: 0.8 }, { x: 0.4, y: 0.7 }, { x: 0.7, y: 0.7 },
                            { x: 0.8, y: 0.8 }, { x: 0.9, y: 0.7 }
                        ]
                    },
                    {
                        name: "RATÓN 🐭",
                        points: [
                            { x: 0.2, y: 0.6 }, { x: 0.25, y: 0.5 }, { x: 0.35, y: 0.4 }, { x: 0.3, y: 0.25 }, { x: 0.4, y: 0.3 },
                            { x: 0.5, y: 0.25 }, { x: 0.55, y: 0.4 }, { x: 0.65, y: 0.45 }, { x: 0.8, y: 0.45 }, { x: 0.9, y: 0.55 },
                            { x: 0.95, y: 0.45 }, { x: 0.95, y: 0.65 }, { x: 0.9, y: 0.65 }, { x: 0.85, y: 0.75 }, { x: 0.75, y: 0.75 },
                            { x: 0.6, y: 0.7 }, { x: 0.5, y: 0.75 }, { x: 0.4, y: 0.7 }, { x: 0.3, y: 0.65 }, { x: 0.25, y: 0.6 }
                        ]
                    }
                ];
            ...
            loadLevel(idx) {
                ...
                if (this.documentTitle) this.documentTitle.textContent = `Nivel ${this.level + 1}: ${this.currentDot} ➡️ ${this.currentDot + 1}`;
                this.lines = [];
                this.draw();
            }
