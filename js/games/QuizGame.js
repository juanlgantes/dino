export class QuizGame {
  constructor(activityData, app) {
    ...
    this.data = {
      ...activityData,
      games: [...activityData.games].sort(() => Math.random() - 0.5),
    };
  ...
  renderQuestion() {
    ...
    titleH2.style.cssText =
      "color: var(--text-dark); margin-bottom: 30px; font-size: 1.5em;";
    ...
    card.style.cssText =
      "background: white; padding: 30px; border-radius: 15px; box-shadow: 0 3px 10px rgba(0,0,0,0.1); margin-bottom: 20px;";

    const questionH3 = document.createElement("h3");
    questionH3.style.cssText =
      "color: #667eea; font-size: 1.8em; margin-bottom: 30px; display: flex; align-items: center; justify-content: center; gap: 15px;";
    ...
    btnSpeak.style.cssText =
      "background: #e0c3fc; border: none; width: 40px; height: 40px; border-radius: 50%; font-size: 1.2em; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 5px rgba(0,0,0,0.2); transition: transform 0.1s;";
    btnSpeak.onclick = (e) => {
      e.stopPropagation();
      this.speakCurrent();
    ...
    btnStop.style.cssText =
      "background: #ff7675; border: none; width: 40px; height: 40px; border-radius: 50%; font-size: 1.2em; cursor: pointer; display: flex; align-items: center; justify-content: center; box-shadow: 0 2px 5px rgba(0,0,0,0.2); transition: transform 0.1s; margin-left: 10px;";
    btnStop.onclick = (e) => {
      e.stopPropagation();
