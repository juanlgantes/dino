export class SnakeGame {
  ...
  startGame() {
    ...
    this.scoreEl.style.cssText =
      "color:white; font-size:1.5em; margin-bottom:10px; width:100%; text-align:center;";
  ...
  renderControls() {
    ...
    const createBtn = (txt, dx, dy) => {
      ...
      b.textContent = txt;
      b.style.cssText =
        "width:60px; height:60px; font-size:2em; background:rgba(255,255,255,0.2); border:none; border-radius:10px; color:white;";
