export class FighterGame {
  ...
  init() {
    ...
    this.c.style.background =
      "linear-gradient(to bottom, #87CEEB 0%, #E0F7FA 50%, #8D6E63 50%, #5D4037 100%)";
    ...
    // Block Logic
    // Mouse
    btnBlock.onmousedown = (e) => {
      e.preventDefault();
      this.startBlock();
    };
    btnBlock.onmouseup = (e) => {
      e.preventDefault();
      this.endBlock();
    };
    btnBlock.onmouseleave = (e) => {
      e.preventDefault();
      this.endBlock();
    };
    // Touch
    btnBlock.ontouchstart = (e) => {
      e.preventDefault();
      this.startBlock();
    };
    btnBlock.ontouchend = (e) => {
      e.preventDefault();
      this.endBlock();
    };
  ...
  } // Re-using error tone as "thud"
  playMetalSound() {
    window.app.audio.playPop();
  } // Re-using pop as "tink"
