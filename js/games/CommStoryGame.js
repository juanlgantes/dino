export class CommStoryGame {
  constructor(data, container) {
    ...
    this.story = [
      ...
      {
        text: "Un amigable pajarito 🐦 lo encontró y se lo devolvió.",
        bg: "#a8edea",
      },
      {
        text: "Dino se puso muy feliz 😄 y le dio las gracias.",
        bg: "#f6d365",
      },
    ];
  ...
  renderSlide() {
    ...
    this.btnPrev.style.visibility =
      this.currentSlide > 0 ? "visible" : "hidden";
    this.btnNext.innerHTML =
      this.currentSlide === this.story.length - 1
        ? "❓ ¡A las preguntas!"
        : "➡️ Continuar";
  ...
  endGame() {
    ...
    document.getElementById("btnReplayStory").onclick = () =>
