export class CommArtGame {
  ...
  bindEvents() {
    // Toolbar
    document.getElementById("artColor").onchange = (e) =>
      (this.color = e.target.value);
    document.getElementById("artSize").oninput = (e) =>
  ...
  endGame() {
    ...
    document.getElementById("btnReplayArt").onclick = () =>
      window.app.startGame(window.app.currentGameKey);
    document.getElementById("btnExitArt").onclick = () =>
