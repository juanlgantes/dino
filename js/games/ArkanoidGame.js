export class ArkanoidGame {
            ...
            init() {
                ...
                this.canvas.style.cssText = 'background: linear-gradient(to bottom, #000000, #434343); width: 100%; height: 100%; display: block;';
                ...
                this.ui.style.cssText = 'position: absolute; top: 0; left: 0; width: 100%; height: 100%; pointer-events: none; display: flex; justify-content: center; align-items: center;';
                ...
                // Input
                this.canvas.addEventListener('mousemove', (e) => this.movePaddle(e.clientX));
            ...
            draw() {
                ...
                // Draw rounded rect
                this.roundRect(this.ctx, this.paddle.x, this.paddle.y, this.paddle.w, this.paddle.h, 10, true);
                // Center bone emoji
                this.ctx.textAlign = 'center';
                this.ctx.textBaseline = 'middle';
                this.ctx.fillText('🦴', this.paddle.x + this.paddle.w/2, this.paddle.y + this.paddle.h/2);
                ...
                this.bricks.forEach(b => {
                    if(b.active) {
                        ...
                        this.ctx.fillText(b.type === 'ice' ? '🧊' : '🪨', b.x + b.w/2, b.y + b.h/2);
                    }
                });
            }
