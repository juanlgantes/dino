export class CommPhonemesGame {
    constructor(data, container) {
        ...
        this.c = container;
        this.running = true;
        this.c.style.background = 'linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%)';
    ...
    init() {
        ...
        if (window.app.audio && window.app.audio.speak) {
            window.app.audio.speak(`Traza la letra ${this.currentData.letter}`, 'es-ES');
        }
    }
    ...
    drawTemplate() {
        ...
        this.ctx.fillText(this.currentData.letter, this.canvas.width / 2, this.canvas.height / 2);

        // Dashed outline
        this.ctx.strokeStyle = '#bdc3c7';
        this.ctx.lineWidth = 5;
        this.ctx.setLineDash([10, 10]);
        this.ctx.strokeText(this.currentData.letter, this.canvas.width / 2, this.canvas.height / 2);
    ...
    startBubblePhase() {
        ...
        if (window.app.audio && window.app.audio.speak) {
            window.app.audio.speak(`¡Muy bien! Ahora explota lo que empieza por ${this.currentData.letter}`, 'es-ES');
        }
        ...
        this.correctToPop = this.currentData.bubbles.filter(b => b.correct).length;
    }
